"""
Django settings for uguidid_49 project.
...
WSGI_APPLICATION = 'uguidid_49.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "uguidid_49 API",
    "DESCRIPTION": "API documentation for uguidid_49 App",
    "VERSION": "v1",
}
